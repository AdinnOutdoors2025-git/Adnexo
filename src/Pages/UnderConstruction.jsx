...
function UnderConstruction() {
  ...
  //     {/* Navbar */}
  //     {/* <nav className="uc_navbar">
  //       <div className="uc_nav-container">
  //         <div className="uc_nav-logo">
  //           <img src='https://www.adinn.com/_next/static/media/AdinnLogoBlack.5c3570b9.svg' alt="Logo" />
  //         </div>

  //         <div className="uc_nav-menu">
  //           {['Home', 'About us', 'Work', 'Info', 'Contact us'].map((item) => (
  //             <a key={item} href="#" className="uc_nav-link">
  //               {item}
  //               <span className="uc_nav-link-underline"></span>
  //             </a>
  //           ))}
  //         </div>
  //       </div>
  ...
  //           {/* <div className="uc_gradient-circle uc_circle-3"></div> */}
  //         </div>

  //         {/* Main Container - Full Banner */}
  ...
  //               {/* Meaningful paragraph about site being under construction */}
  ...
  //               {/* <button className="uc_more-info-btn">
  //                 <span>MORE INFO</span>
  //               </button> */}
  //             </div>
